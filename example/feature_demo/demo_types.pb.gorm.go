...
import (
	context "context"
	fmt "fmt"
	auth "github.com/armezit/atlas-app-toolkit/auth"
	gateway "github.com/armezit/atlas-app-toolkit/gateway"
	gorm1 "github.com/armezit/atlas-app-toolkit/gorm"
	errors "github.com/armezit/protoc-gen-gorm/errors"
	user "github.com/armezit/protoc-gen-gorm/example/user"
	types "github.com/armezit/protoc-gen-gorm/types"
...
type TestTypesORM struct {
	...
	BecomesInt                string
	CreatedAt                 *time.Time
	JsonField                 datatypes.JSON `gorm:"type:jsonb"`
...
func (m *TestTypes) ToORM(ctx context.Context) (TestTypesORM, error) {
	...
	if m.JsonField != nil {
		to.JsonField = []byte(m.JsonField.Value)
	}
